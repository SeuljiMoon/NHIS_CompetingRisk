...
This analysis will utilize the **MatchIt** package to perform a 1:4 matching
...
# before matching
tb1_4<-CreateTableOne(data=frac_entire8[,.SD,.SDcols=c(factor_vars,"indexyear","age","c90_yn", "death_years")],factorVars = c(factor_vars), smd=TRUE, strata="c90_yn", test=F); print(tb1_4,nonnormal = c("death_years"),smd=T)

# after matching
tb1_1<-CreateTableOne(data=frac_entire8.match[,.SD,.SDcols=c(factor_vars,"indexyear","age","c90_yn", "death_years")],factorVars = c(factor_vars), smd=TRUE, strata="c90_yn", test=F); print(tb1_1,smd=T)
